...
## SQL  
### Цель проекта:   
- выгрузить нужные данные из Clickhouse и проанализировать их.  
...
### В работе использовались:   
- СУБД Clickhouse, библиотека pandahouse для использования синтаксиса SQL в запросах в jupyter notebook.   

---

## Мини проекты по статистике

## Couriers_project.ipynb  
### Цель проекта:  
...
## Bootstrap_project.ipynb  
### Цель проекта:  
- сравнить результат между тестом и контролем по двум кейсам: бутстрапом и u-тестом Манна-Уитни.  
### Результат:  
- сделаны выводы:
    ...
    - статистически значимых различий между тестовой и контрольной групп нет.  
### В работе использовалась:  
- бутстрап (с np.mean);  
...
## Photos_project.ipynb  
### Цель проекта: 
- определить, между какими группами есть статистически значимые различия;
...
- провести two-way anova, чтобы понять, есть ли у нас значимые различия между любыми двумя группами;
- проводим Т-тест с критерием Тьюки, чтобы понять, между какими группами есть различия.
### Результат:  
- визуализированны распределения, проверены на нормальность;
- с помощью критерия Тьюки определелили различия между группами;
- с помощью боксплота определили, что заказов больше у формы картинки B (квадратные);  
- для обоих сегментов показатели статистически значимо увеличились по сравнению с контрольной группой;
- приняли решение выкатывать новое обновление.
### В работе использовалась: 
...
## Cars_linear_regression_project.ipynb  
### Цель проекта:  
